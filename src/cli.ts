import type { CommandArgs, DeepWriteable, UpdateCandidate } from './types'
...
export async function runCliWithOptions(options: CommandArgs): Promise<void> {
    ...
    const checkResult = await checkUpdateDependencies(projectConfig, {
        ...
        fetchPackageMetadata: getPackageMetadata,
    })
